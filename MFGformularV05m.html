	...
	<form action="MFGbearbeite_csvX.php" id="user">
		...
		<table>
			<tr> 
				...
				<td> <input type="text" name="koordinate" id="koordinate" maxlength="21" style="background-color:#dddddd" readOnly value=""> </td>			</tr>
		</table>
	    </fieldset>
...
<!-- rechte Spalte hier Inhalt einfügen -->
	<td style="width:45%" "text-align:top">
		...
		<li> Fülle das Formular aus. 
			...
			<br> Du kannst <b>sowohl Bahn als auch Auto-Fahrgemeinschaften</b> eingeben, wenn Du vorerst beide Optionen offen halten möchtest. </li>
...
<br><br><br><br><br><br><br><br><br><br><br><br>
		<h3>Bestehenden Marker löschen</h3>
		<p> Gib die <b>identische</B> E-Mail des Markers, den Du löschen willst, in das Feld unter „Eintrag entfernen“ ein und klicke den gelben Button.
